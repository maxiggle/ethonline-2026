...
class PurchaseDetailRoute extends PageRouteInfo<PurchaseDetailRouteArgs> {
  PurchaseDetailRoute({
    ...
    PurchaseRequest? initialPurchase,
  ...
  static PageInfo page = PageInfo(
    name,
    builder: (data) {
      final args = data.argsAs<PurchaseDetailRouteArgs>();
...
class PurchaseDetailRouteArgs {
  ...
  @override
  String toString() {
    return 'PurchaseDetailRouteArgs{key: $key, purchaseRequestId: $purchaseRequestId, initialPurchase: $initialPurchase, apiService: $apiService}';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! PurchaseDetailRouteArgs) return false;
  ...
  int get hashCode =>
      key.hashCode ^
      purchaseRequestId.hashCode ^
      initialPurchase.hashCode ^
      apiService.hashCode;
}
